...
- Gotowe APK: dist/Pixelate-1.5.1.apk
...
- Przywrócono sprawdzoną kolejność z 1.4.0: najpierw natywne akcje przewijania, a gest dopiero po pełnym limicie 20 prób.
- Usunięto eksperymentalny fallback uruchamiany po dwóch obserwacjach bez postępu, ponieważ na niektórych Pixelach mógł kolidować z animacją launchera.
- Pozostałe funkcje 1.5.0, w tym automatyczny zapis ustawień, pozostają bez zmian.

## Co wniosła wersja 1.5.0

- Wersja eksperymentalna próbowała wykrywać położenie kart i szybciej przełączać się na gest. W 1.5.1 ta część została wycofana na rzecz bardziej niezawodnej ścieżki.
